 ...
 * file
 */
public class ReadInstanceUnitario {
...
private int[][] transposta;   // transposta da matrix para trabalhar com as máquinas nas linhas
     ...
     */
    public ReadInstanceUnitario(String name) {
        fileName_ = name;
        //this.num = num;
    } // ReadInstance
  ...
  public void loadInstance() throws IOException {        
    ...
    public void createSingleObjectiveInstance(int[] weights) {
        ...
        if (weights.length != objectives_) {
            Logger.getLogger(ReadInstanceUnitario.class.getName()).log(Level.SEVERE,
        ...
        try {
            ...
            Logger.getLogger(ReadInstanceUnitario.class.getName()).log(Level.SEVERE, "The file cannot be created", ex);
        } catch (IOException ex1) {
            Logger.getLogger(ReadInstanceUnitario.class.getName()).log(Level.SEVERE, "Error writting in the file", ex1);
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        for (int numInst = 1; numInst <= 10; numInst++) {
            ReadInstanceUnitario ri = new ReadInstanceUnitario("C:\\Users\\qwert\\Desktop\\Jmetal\\Instancias_Due\\DD_Ta001.txt");
            ri.loadInstance();
            System.out.println("");
            System.out.println("");
        }
