...
//    exp.indicatorList_   = new String[] {"HV", "SPREAD", "IGD", "EPSILON"} ;
    //comentado acima e modificado por Sandra como a seguir
    exp.experimentName_  = "NSGAIIStudy" ;
    exp.algorithmNameList_   = new String[] {
      "NSGAIIa", "NSGAIIb", "NSGAIIc", "NSGAIId"} ;
    exp.problemList_     = new String[] {
    ...
    //comentado acima e modificado por Sandra como a seguir
    exp.experimentBaseDirectory_ = "/home/usuario/JavaProjects/" +
                                   exp.experimentName_;
    exp.paretoFrontDirectory_ = "/home/usuario/JavaProjects/data/paretoFronts";
